    ...
    <ScrollView>
      ...
      <Card containerStyle={{ width: "60%", marginLeft: "20%" }}>
        ...
        <Card.Image
          ...
          source={{
            uri:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnNYASM4KpyE7Omb22Kezrhv49Amj6uiIn9g&usqp=CAU",
          }}
        ></Card.Image>
        <Card.Divider />
        <View style={{ width: "100%", alignItems: "center" }}>
      ...
      <Card containerStyle={{ width: "60%", marginLeft: "20%" }}>
        ...
        <Card.Image
          ...
          source={{
            uri:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvdbs9xrkjupSkmWm4fFn24wGe4WDm76xvLA&usqp=CAU",
          }}
        ></Card.Image>
        <Card.Divider />
        <View style={{ width: "100%", alignItems: "center" }}>
